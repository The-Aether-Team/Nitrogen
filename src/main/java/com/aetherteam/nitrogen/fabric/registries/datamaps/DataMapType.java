 ...
 *
 * <p>
 * You can access a data map using {@link net.neoforged.neoforge.registries.IRegistryExtension#getDataMap(DataMapType)} and {@link IWithData#nitrogen_fabric$getData(DataMapType)}. <br>
 * You can usually go through {@linkplain net.minecraft.core.Holder#nitrogen_fabric$getData(DataMapType)} Holder} implementations in order to get the data of an object directly.
 *
