...
public class DeferredHolder<R, T extends R> implements Holder<R>, Supplier<T> {
     ...
     */
    @Override
    public ResourceKey<R> nitrogen_fabric$getKey() {
        return this.key;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof Holder<?> h && h.kind() == Kind.REFERENCE && h.nitrogen_fabric$getKey() == this.key;
    }
     ...
     *
     * @return {@code true} if the filter matches {@linkplain #nitrogen_fabric$getKey() this DH's resource key}
     */
    @Override
    ...
    /**
     * Returns an {@link Either#left()} containing {@linkplain #nitrogen_fabric$getKey() the resource key of this holder}.
     *
     * @apiNote This method is implemented for {@link Holder} compatibility, but {@link #nitrogen_fabric$getKey()} should be preferred.
     */
    @Override
     ...
     *
     * @return a present optional containing {@linkplain #nitrogen_fabric$getKey() the resource key of this holder}
     * @apiNote This method is implemented for {@link Holder} compatibility, but {@link #nitrogen_fabric$getKey()} should be preferred.
     */
    @Override
    ...
    @Override
    public Holder<R> nitrogen_fabric$getDelegate() {
        bind(false);
        return this.holder != null ? this.holder.nitrogen_fabric$getDelegate() : this;
    }
}
