...
public abstract class ItemAttributeModifiersPredicateMixin {
    ...
    private List<ItemAttributeModifiers.Entry> nitrogen_fabric$modifyAttributeEvent(ItemAttributeModifiers instance, Operation<List<ItemAttributeModifiers.Entry>> original, @Local(argsOnly = true) ItemStack stack) {
