...
public abstract class ProjectileUtilMixin {
    ...
    private static boolean nitrogen_fabric$adjustIfEntityHit(boolean original, @Local(type = Entity.class, ordinal = 2) Entity entity2) {
        return original && !entity2.nitrogen_fabric$canRiderInteract();
    }
}
