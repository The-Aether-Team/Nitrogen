...
public abstract class PlayerRendererMixin extends LivingEntityRenderer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private <T extends LivingEntity> void nitrogen_fabric$onPlayerRenderer(PlayerRenderer instance, T entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight, Operation<Void> original) {
    ...
    private void nitrogen_fabric$onRenderLeftHand(PoseStack poseStack, MultiBufferSource buffer, int packedLight, AbstractClientPlayer player, Operation<Void> original){
    ...
    private void nitrogen_fabric$onRenderRightHand(PoseStack poseStack, MultiBufferSource buffer, int packedLight, AbstractClientPlayer player, Operation<Void> original){
        float partialTicks = Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(!player.level().tickRateManager().isEntityFrozen(player));
