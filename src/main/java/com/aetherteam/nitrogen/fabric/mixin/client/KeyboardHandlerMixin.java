...
public abstract class KeyboardHandlerMixin {
    ...
    private static boolean nitrogen_fabric$afterKeyPressedEvent(Screen instance, int keyCode, int scanCode, int modifiers, Operation<Boolean> original, @Local(argsOnly = true) Screen screen) {
