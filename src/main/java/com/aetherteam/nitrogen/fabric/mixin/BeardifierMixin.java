...
public abstract class BeardifierMixin {
    ...
    private static boolean nitrogen_fabric$checkCustomBeardifier(Object object, Operation<Boolean> original) {
    ...
    private static boolean nitrogen_fabric$useCustomBeardifier(ObjectList instance, Object object, Operation<Boolean> original, @Local() StructurePiece structurePiece) {
