        ...
        widgets.add(
            Widgets.wrapRenderer(
                ...
                (graphics, bound, mouseX, mouseY, delta) -> {
                    ...
                    graphics.blitSprite(RenderType::guiTextured, this.getBackgroundTexture(), bound.x - 1, bound.y - 3, 14, 14);

                    int yPosition = bound.y + height;

                    graphics.enableScissor(bound.x, yPosition - 3, bound.x + 14, yPosition + 11);
                    graphics.blitSprite(RenderType::guiTextured, this.getTexture(), bound.x, bound.y - 3, 14, 14);
